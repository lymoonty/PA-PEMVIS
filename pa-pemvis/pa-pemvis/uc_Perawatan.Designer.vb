...
Partial Class uc_Perawatan
    ...
    Private Sub InitializeComponent()
        ...
        Label6.Location = New Point(38, 42)
        Label6.Margin = New Padding(2, 0, 2, 0)
        Label6.Name = "Label6"
        Label6.Size = New Size(270, 34)
        Label6.TabIndex = 20
        ...
        btnCari.Location = New Point(1065, 608)
        btnCari.Margin = New Padding(2)
        btnCari.Name = "btnCari"
        btnCari.Size = New Size(101, 49)
        btnCari.TabIndex = 25
        btnCari.Text = "Cari"
        ...
        btnHapus.Location = New Point(899, 608)
        btnHapus.Margin = New Padding(2)
        btnHapus.Name = "btnHapus"
        btnHapus.Size = New Size(111, 49)
        ...
        btnUpdate.Location = New Point(724, 608)
        btnUpdate.Margin = New Padding(2)
        btnUpdate.Name = "btnUpdate"
        btnUpdate.Size = New Size(106, 49)
        ...
        btnSimpan.Location = New Point(551, 608)
        btnSimpan.Margin = New Padding(2)
        btnSimpan.Name = "btnSimpan"
        btnSimpan.Size = New Size(108, 49)
        ...
        Panel5.Location = New Point(38, 603)
        Panel5.Margin = New Padding(2)
        Panel5.Name = "Panel5"
        Panel5.Size = New Size(132, 58)
        Panel5.TabIndex = 17
        ' 
        ' Label2
        ' 
        ...
        Panel4.Location = New Point(551, 104)
        Panel4.Margin = New Padding(2)
        Panel4.Name = "Panel4"
        Panel4.Size = New Size(615, 458)
        Panel4.TabIndex = 21
        ' 
        ' dgvPerawatan
        ' 
        ...
        Panel2.Location = New Point(38, 104)
        Panel2.Margin = New Padding(2)
        Panel2.Name = "Panel2"
        Panel2.Size = New Size(471, 458)
        Panel2.TabIndex = 18
        ' 
        ' Panel3
        ' 
        ...
        Panel3.Name = "Panel3"
        Panel3.Size = New Size(428, 384)
        Panel3.TabIndex = 16
        ' 
        ' PictureBox1
        ' 
        PictureBox1.Image = CType(resources.GetObject("PictureBox1.Image"), Image)
        PictureBox1.Location = New Point(0, 171)
        ...
        txtNama.Location = New Point(207, 48)
        txtNama.Margin = New Padding(2)
        txtNama.Name = "txtNama"
        txtNama.Size = New Size(192, 31)
        txtNama.TabIndex = 1
        ' 
        ' Label5
        ' 
        ...
        txtHarga.Location = New Point(207, 91)
