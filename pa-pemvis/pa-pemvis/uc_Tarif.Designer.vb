...
Partial Class uc_Tarif
    ...
    Private Sub InitializeComponent()
        ...
        Panel5.Location = New Point(612, 62)
        Panel5.Margin = New Padding(2)
        Panel5.Name = "Panel5"
        Panel5.Size = New Size(572, 644)
        Panel5.TabIndex = 2
        ' 
        ' Panel7
        ' 
        ...
        Panel7.Location = New Point(20, 431)
        Panel7.Margin = New Padding(2)
        Panel7.Name = "Panel7"
        Panel7.Size = New Size(529, 125)
        Panel7.TabIndex = 17
        ' 
        ' Label9
        ' 
        ...
        txtInfoPerawatan.Location = New Point(190, 15)
        txtInfoPerawatan.Margin = New Padding(2)
        txtInfoPerawatan.Name = "txtInfoPerawatan"
        txtInfoPerawatan.ReadOnly = True
        txtInfoPerawatan.Size = New Size(192, 31)
        ...
        Label10.Location = New Point(18, 69)
        ...
        txtHargaPerawatan.Location = New Point(190, 66)
        txtHargaPerawatan.Margin = New Padding(2)
        txtHargaPerawatan.Name = "txtHargaPerawatan"
        txtHargaPerawatan.Size = New Size(192, 31)
        ...
        btnUpdatePerawatan.Location = New Point(20, 572)
        btnUpdatePerawatan.Margin = New Padding(2)
        btnUpdatePerawatan.Name = "btnUpdatePerawatan"
        btnUpdatePerawatan.Size = New Size(172, 34)
        ...
        Panel6.Location = New Point(20, 52)
        Panel6.Margin = New Padding(2)
        Panel6.Name = "Panel6"
        Panel6.Size = New Size(529, 362)
        Panel6.TabIndex = 16
        ' 
        ' dgvPerawatan
        ' 
        ...
        Panel4.Location = New Point(20, 431)
        Panel4.Margin = New Padding(2)
        Panel4.Name = "Panel4"
        Panel4.Size = New Size(529, 125)
        Panel4.TabIndex = 17
        ' 
        ' Label6
        ' 
        ...
        txtInfoKandang.Location = New Point(172, 20)
        txtInfoKandang.Margin = New Padding(2)
        txtInfoKandang.Name = "txtInfoKandang"
        txtInfoKandang.ReadOnly = True
        txtInfoKandang.Size = New Size(192, 31)
        ...
        Label7.Location = New Point(18, 69)
        Label7.Margin = New Padding(2, 0, 2, 0)
        Label7.Name = "Label7"
        Label7.Size = New Size(144, 24)
        Label7.TabIndex = 2
        ...
        txtHargaKandang.Location = New Point(172, 66)
        txtHargaKandang.Margin = New Padding(2)
        txtHargaKandang.Name = "txtHargaKandang"
        txtHargaKandang.Size = New Size(192, 31)
        ...
        btnUpdateKandang.Location = New Point(20, 572)
        btnUpdateKandang.Margin = New Padding(2)
        btnUpdateKandang.Name = "btnUpdateKandang"
        btnUpdateKandang.Size = New Size(160, 34)
        ...
        dgvKandang.Location = New Point(12, 38)
        dgvKandang.Margin = New Padding(2)
        dgvKandang.Name = "dgvKandang"
        dgvKandang.RowHeadersWidth = 82
        dgvKandang.Size = New Size(505, 312)
